...
#define LT_LEFT_DI_Pin GPIO_PIN_1
#define LT_LEFT_DI_GPIO_Port GPIOA
#define LT_LEFT_CI_Pin GPIO_PIN_3
#define LT_LEFT_CI_GPIO_Port GPIOA
...
#define LT_RIGHT_CI_Pin GPIO_PIN_11
#define LT_RIGHT_CI_GPIO_Port GPIOD
#define LT_RIGHT_DI_Pin GPIO_PIN_13
#define LT_RIGHT_DI_GPIO_Port GPIOD
#define LCD_GPIO2_Pin GPIO_PIN_7
#define LCD_GPIO2_GPIO_Port GPIOC
#define LCD_GPIO1_Pin GPIO_PIN_9
#define LCD_GPIO1_GPIO_Port GPIOC
#define LCD_GPIO0_Pin GPIO_PIN_9
#define LCD_GPIO0_GPIO_Port GPIOA
#define CAN2_RX_Pin GPIO_PIN_11
#define CAN2_RX_GPIO_Port GPIOA
#define CAN2_TX_Pin GPIO_PIN_12
#define CAN2_TX_GPIO_Port GPIOA
#define LT_BAR_CI_Pin GPIO_PIN_2
#define LT_BAR_CI_GPIO_Port GPIOD
#define LT_BAR_DI_Pin GPIO_PIN_4
#define LT_BAR_DI_GPIO_Port GPIOD
