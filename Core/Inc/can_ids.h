...
constexpr uint16_t CAN_LV_ADDR       = 0x507; // bytes[0:1] LV V (mV); bytes[2:3] regen torque s16; bytes[4:5] eff score s16×0.0001; byte[6] dash_mode; byte[7] energy remaining %
